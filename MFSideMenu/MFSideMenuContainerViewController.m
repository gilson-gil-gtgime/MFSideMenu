...
+(MFSideMenuContainerViewController *)containerWithCenterViewController:(id)centerViewController
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {

        NSLog( @"containerWithCenterViewController: %@ leftMenuViewController: %@ rightMenuViewController: %@ - MFSideMenuContainerViewController", centerViewController, leftMenuViewController, rightMenuViewController );
...
-(id)init {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog(@"init - MFSideMenuContainerViewController");
    }
...
-(id)initWithCoder:(NSCoder *)inCoder {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"initWithCoder: %@ - MFSideMenuContainerViewController", inCoder );
    }
...
-(void)setDefaultSettings {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"setDefaultSettings - MFSideMenuContainerViewController" );
    }
...
-(void)setupMenuContainerView {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"setupMenuContainerView - MFSideMenuContainerViewController" );
    }
...
-(void)viewDidLoad {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"viewDidLoad - MFSideMenuContainerViewController" );
    }
...
-(void)viewDidAppear:(BOOL)animated {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"viewDidAppear - MFSideMenuContainerViewController" );
    }
...
-(void)viewWillLayoutSubviews {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"viewWillLayoutSubviews - MFSideMenuContainerViewController" );
    }
...
-(UIStatusBarStyle)preferredStatusBarStyle {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"preferredStatusBarStyle - MFSideMenuContainerViewController" );
    }
...
-(BOOL)prefersStatusBarHidden {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"prefersStatusBarHidden - MFSideMenuContainerViewController" );
    }
...
-(UIStatusBarAnimation)preferredStatusBarUpdateAnimation {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"preferredStatusBarUpdateAnimation - MFSideMenuContainerViewController" );
    }
...
-(void)hideStatusBar {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"hideStatusBar - MFSideMenuContainerViewController" );
    }
...
-(void)showStatusBar {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"showStatusBar - MFSideMenuContainerViewController" );
    }
...
-(UIInterfaceOrientationMask)supportedInterfaceOrientations {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"supportedInterfaceOrientations - MFSideMenuContainerViewController" );
    }
...
-(BOOL)shouldAutorotate {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"shouldAutorotate - MFSideMenuContainerViewController" );
    }
...
-(UIInterfaceOrientation)preferredInterfaceOrientationForPresentation {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"preferredInterfaceOrientationForPresentation - MFSideMenuContainerViewController" );
    }
...
-(void)willAnimateRotationToInterfaceOrientation:(UIInterfaceOrientation)toInterfaceOrientation duration:(NSTimeInterval)duration {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"willAnimateRotationToInterfaceOrientation: duration: - MFSideMenuContainerViewController" );
    }
...
-(void)didRotateFromInterfaceOrientation:(UIInterfaceOrientation)fromInterfaceOrientation {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"didRotateFromInterfaceOrientation: - MFSideMenuContainerViewController" );
    }
...
-(void)setLeftMenuViewController:(UIViewController *)leftSideMenuViewController {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"setLeftMenuViewController: - MFSideMenuContainerViewController" );
    }
...
-(void)setCenterViewController:(UIViewController *)centerViewController {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"setCenterViewController: - MFSideMenuContainerViewController" );
    }
...
-(void)setRightMenuViewController:(UIViewController *)rightSideMenuViewController {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"setRightMenuViewController: - MFSideMenuContainerViewController" );
    }
...
-(void)removeChildViewControllerFromContainer:(UIViewController *)childViewController {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"removeChildViewControllerFromContainer: - MFSideMenuContainerViewController" );
    }
...
-(UIPanGestureRecognizer *)panGestureRecognizer {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"panGestureRecognizer: - MFSideMenuContainerViewController" );
    }
...
-(void)addGestureRecognizers {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"addGestureRecognizers: - MFSideMenuContainerViewController" );
    }
...
-(void)removeCenterGestureRecognizers {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"removeCenterGestureRecognizers: - MFSideMenuContainerViewController" );
    }
...
-(void)addCenterGestureRecognizers {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"addCenterGestureRecognizers: - MFSideMenuContainerViewController" );
    }
...
-(UITapGestureRecognizer *)centerTapGestureRecognizer {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"centerTapGestureRecognizer: - MFSideMenuContainerViewController" );
    }
...
-(void)toggleLeftSideMenuCompletion:(void (^)(void))completion {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"toggleLeftSideMenuCompletion: - MFSideMenuContainerViewController" );
    }
...
-(void)toggleRightSideMenuCompletion:(void (^)(void))completion {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"toggleRightSideMenuCompletion: - MFSideMenuContainerViewController" );
    }
...
-(void)openLeftSideMenuCompletion:(void (^)(void))completion {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"openLeftSideMenuCompletion: - MFSideMenuContainerViewController" );
    }
...
-(void)openRightSideMenuCompletion:(void (^)(void))completion {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"openRightSideMenuCompletion: - MFSideMenuContainerViewController" );
    }
...
-(void)closeSideMenuCompletion:(void (^)(void))completion {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"closeSideMenuCompletion: - MFSideMenuContainerViewController" );
    }
...
-(void)setMenuState:(MFSideMenuState)menuState {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"setMenuState: - MFSideMenuContainerViewController" );
    }
...
-(void)setMenuState:(MFSideMenuState)menuState completion:(void (^)(void))completion {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"setMenuState: completion: - MFSideMenuContainerViewController" );
    }

    void (^innerCompletion)() = ^ {

        if ( [MFSideMenuContainerViewController showLog] ) {
            NSLog( @"setMenuState: completion: ( innerCompletion() ) - MFSideMenuContainerViewController" );
        }
        ...
        if ( _menuState == MFSideMenuStateClosed ) {
            eventType = MFSideMenuStateEventMenuDidClose;
        } else {
            eventType = MFSideMenuStateEventMenuDidOpen;
        }

        [self sendStateEventNotification:eventType];

        [self callCenterViewControllerViewWillAppear];
...
-(void)leftMenuWillShow {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"leftMenuWillShow - MFSideMenuContainerViewController" );
    }

    [self.leftMenuViewController view].hidden = NO;
    [self.menuContainerView bringSubviewToFront:[self.leftMenuViewController view]];

    [[self viewControllerActive] viewWillDisappear:YES];
...
-(void)rightMenuWillShow {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"rightMenuWillShow - MFSideMenuContainerViewController" );
    }
...
-(void)sendStateEventNotification:(MFSideMenuStateEvent)event {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"sendStateEventNotification - MFSideMenuContainerViewController" );
    }
...
-(void)setLeftSideMenuFrameToClosedPosition {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"setLeftSideMenuFrameToClosedPosition - MFSideMenuContainerViewController" );
    }
...
-(void)setRightSideMenuFrameToClosedPosition {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"setRightSideMenuFrameToClosedPosition - MFSideMenuContainerViewController" );
    }
...
-(void)alignLeftMenuControllerWithCenterViewController {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"alignLeftMenuControllerWithCenterViewController - MFSideMenuContainerViewController" );
    }
...
-(void)alignRightMenuControllerWithCenterViewController {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"alignRightMenuControllerWithCenterViewController - MFSideMenuContainerViewController" );
    }
    ...
    rightMenuFrame.origin.x = self.menuContainerView.frame.size.width - _rightMenuWidth + xOffset / xPositionDivider + _rightMenuWidth / xPositionDivider;
...
-(void)setMenuWidth:(CGFloat)menuWidth {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"setMenuWidth: - MFSideMenuContainerViewController" );
    }
...
-(void)setLeftMenuWidth:(CGFloat)leftMenuWidth {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"setLeftMenuWidth: - MFSideMenuContainerViewController" );
    }
...
-(void)setRightMenuWidth:(CGFloat)rightMenuWidth {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"setRightMenuWidth: - MFSideMenuContainerViewController" );
    }
...
-(void)setMenuWidth:(CGFloat)menuWidth animated:(BOOL)animated {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"setMenuWidth: animated: - MFSideMenuContainerViewController" );
    }
...
-(void)setLeftMenuWidth:(CGFloat)leftMenuWidth animated:(BOOL)animated {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"setLeftMenuWidth: animated: - MFSideMenuContainerViewController" );
    }
    ...
    void (^effects)() = ^ {
        ...
        if ( [MFSideMenuContainerViewController showLog] ) {
            NSLog( @"setLeftMenuWidth: animated: ( effects() ) - MFSideMenuContainerViewController" );
        }
...
-(void)setRightMenuWidth:(CGFloat)rightMenuWidth animated:(BOOL)animated {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"setRightMenuWidth: animated: - MFSideMenuContainerViewController" );
    }
...
-(BOOL)centerViewControllerPanEnabled {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"centerViewControllerPanEnabled - MFSideMenuContainerViewController" );
    }

    BOOL isEnabled = ( ( self.panMode & MFSideMenuPanModeCenterViewController ) == MFSideMenuPanModeCenterViewController );
...
-(BOOL)sideMenuPanEnabled {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"sideMenuPanEnabled - MFSideMenuContainerViewController" );
    }
...
-(BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldReceiveTouch:(UITouch *)touch {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"gestureRecognizer: shouldReceiveTouch: - MFSideMenuContainerViewController" );
    }

    if ( [gestureRecognizer isKindOfClass:[UITapGestureRecognizer class]] && self.menuState != MFSideMenuStateClosed ) return YES;
...
-(BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"gestureRecognizerShouldBegin: - MFSideMenuContainerViewController" );
    }
...
-(BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldRecognizeSimultaneouslyWithGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"gestureRecognizer: shouldRecognizeSimultaneouslyWithGestureRecognizer: - MFSideMenuContainerViewController" );
    }
...
-(void)handlePan:(UIPanGestureRecognizer *)recognizer {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"handlePan: - MFSideMenuContainerViewController" );
    }
	...
	if ( recognizer.state == UIGestureRecognizerStateBegan ) {
        ...
        UIViewController *viewControllerActive = [self viewControllerActive];
        UIView *viewActive = viewControllerActive.view;

        if ( [recognizer locationInView:viewActive].x > 50  ) {
...
-(void)handleRightPan:(UIPanGestureRecognizer *)recognizer {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"handleRightPan: - MFSideMenuContainerViewController" );
    }
...
-(void)handleLeftPan:(UIPanGestureRecognizer *)recognizer {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"handleLeftPan: - MFSideMenuContainerViewController" );
    }
...
-(void)centerViewControllerTapped:(id)sender {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"centerViewControllerTapped: - MFSideMenuContainerViewController" );
    }
...
-(void)setUserInteractionStateForCenterViewController {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"setUserInteractionStateForCenterViewController - MFSideMenuContainerViewController" );
    }
...
-(void)setCenterViewControllerOffset:(CGFloat)offset animated:(BOOL)animated completion:(void (^)(void))completion {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"setCenterViewControllerOffset: animated: completion: - MFSideMenuContainerViewController" );
    }

    [self setCenterViewControllerOffset:offset additionalAnimations:nil animated:animated completion:completion];
...
-(void)setCenterViewControllerOffset:(CGFloat)offset
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"setCenterViewControllerOffset: additionalAnimations: animated: completion: - MFSideMenuContainerViewController" );
    }

    void (^innerCompletion)() = ^ {

        if ( [MFSideMenuContainerViewController showLog] ) {
            NSLog( @"setCenterViewControllerOffset: additionalAnimations: animated: completion: ( innerCompletion() ) - MFSideMenuContainerViewController" );
        }
...
-(void)callCenterViewControllerViewWillAppear {

    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"callCenterViewControllerViewWillAppear" );
    }

    [[self viewControllerActive] viewWillAppear:YES];

}

-(UIViewController *)viewControllerActive {

    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"viewControllerActive - MFSideMenuContainerViewController" );
    }
...
-(void) setCenterViewControllerOffset:(CGFloat)xOffset {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"setCenterViewControllerOffset: %.2f - MFSideMenuContainerViewController", xOffset );
    }

    [[NSNotificationCenter defaultCenter] postNotificationName:@"MFSideMenuDidChangeCenterViewControllerOffset"
                                                        object:[NSNumber numberWithFloat:xOffset]];
...
-(CGFloat)animationDurationFromStartPosition:(CGFloat)startPosition toEndPosition:(CGFloat)endPosition {
    ...
    if ( [MFSideMenuContainerViewController showLog] ) {
        NSLog( @"animationDurationFromStartPosition: toEndPosition: - MFSideMenuContainerViewController" );
    }
